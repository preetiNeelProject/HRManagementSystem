...
  																  </c:forEach>
																	...
																	<div class="form-group col-sm-6" style="padding: 0px;">
																		...
																		<div>
																			<select name="departmentId" id="departmentId" multiple>
														...
														<div class="row">
															...
															<div class="col-sm-9">
																...
																<div class="form-group col-sm-3" style="padding: 0px;">
																	<label>Pf:</label>
																		<input type="checkbox" name="pf" id="pf"
																			th:field="pf" style="width: 50% !important;"/>
																</div>
																<div class="form-group col-sm-3" style="padding: 0px;">
																	<label>Esi:</label>
																		<input type="checkbox" name="esi"
																			id="esi" style="width: 50% !important;" th:field="*{esi}" />
																</div>
															</div>
														</div>
													</div>
